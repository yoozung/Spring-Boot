			...
			<div class="div-detail">
						...
						<c:choose>
									...
									<form action="/dislike">
										<div>
											<input type="hidden" name="campsiteNo"
												value="${r.campsiteNo}"><br> <input
												type="hidden" name="memberNo" value="${r.memberNo}"><br>
											<c:set var="ls" value="${likesize}" />
											<span class="like-count">좋아요 ${ls}개</span> <input
												class="like-btn" type="submit" value="❤">
							...
							<c:otherwise>
								<form action="/like">
									<div>
										<input type="hidden" name="campsiteNo"
											value="${campsite.campsiteNo}"><br> <input
											type="hidden" name="memberNo" value="${dto.member_no}"><br>
										<c:set var="ls" value="${likesize}" />
										<span class="like-count">좋아요 ${ls}개</span> <input
											class="nolike-btn" type="submit" value="❤">
						...
						<c:if test="${campsite.sbrsCl ne null}">
							...
							<div class="etc-fcl-icon-div">
								...
								<c:if test="${fn:contains(etc, '물놀이장')}">
									<div class="fcl_one">
										<img src="/img/campingDetail/etc_fcl/swimming-pool.png"
					...
					<details>
						...
						<div class="etc-fcl-icon-div">
							...
							<c:if test="${fn:contains(etc, '에어컨')}">
								<div class="fcl_one">
									<img src="/img/campingDetail/glamping_fcl/air-conditioner.png"
			 ...
			 -->
							...
							<td class="review-table-content">
								<div class="review-content-box">
									<div class="review-content">
										...
										<div>${r.content}</div>
										<div>
											후기 번호 : <a href="/reviewDetail?reviewNo=${r.reviewNo}"
												name="review_no" value="${r.reviewNo}">${r.reviewNo}</a>
										</div>
									</div>
								</div> <br>
							</td>
				...
				<div class="review-btn">
					<button type="button" class="yj-review-btn" onclick="reviewWrite()">후기등록</button>
				</div>
			</div>
		</div>
	</div>
