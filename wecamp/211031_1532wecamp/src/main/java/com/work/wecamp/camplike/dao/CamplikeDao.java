...
public interface CamplikeDao {
	 ...
	 * @param member_no
	 */
	@Insert("insert into camplike values(#{campsiteNo}, #{memberNo}, #{likeYn},  #{likeCn})")
...
//	@Select("select * from camplike where member_no =#{member_no}")
//	public List<CamplikeDto> confirmlike(int member_no);
// 
