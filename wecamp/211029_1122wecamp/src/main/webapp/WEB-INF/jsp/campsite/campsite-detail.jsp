...
<link type="text/css" rel="stylesheet"
	href="/resource/css/camp-detail.css">
					...
					<c:if test="${campsite.sbrsCl ne null}">
						...
						<div class="etc-fcl-icon-div">
							<c:if test="${fn:contains(etc, '온수')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/hot-water.png"
							...
							<c:if test="${fn:contains(etc, '전기')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/electric.png"
							...
							<c:if test="${fn:contains(etc, '운동장')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/ground.png"
							...
							<c:if test="${fn:contains(etc, '산책로')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/walk.png"
							...
							<c:if test="${fn:contains(etc, '운동시설')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/gymnasium.png"
							...
							<c:if test="${fn:contains(etc, '마트')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/mart.png"
							...
							<c:if test="${fn:contains(etc, '놀이터')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/playground.png"
							...
							<c:if test="${fn:contains(etc, '편의점')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/shop.png"
							...
							<c:if test="${fn:contains(etc, '물놀이장')}">
								<div class="fcl_one">
									<img
										src="/resource/img/campingDetail/etc_fcl/swimming-pool.png"
							...
							<c:if test="${fn:contains(etc, '무선인터넷')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/wifi.png"
							...
							<c:if test="${fn:contains(etc, '장작판매')}">
								<div class="fcl_one">
									<img src="/resource/img/campingDetail/etc_fcl/firewood.png"
				...
				<details>
					...
					<div class="etc-fcl-icon-div">
						...
						<c:if test="${fn:contains(etc, '에어컨')}">
							<div class="fcl_one">
								<img
									src="/resource/img/campingDetail/glamping_fcl/air-conditioner.png"
